...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--testdataroot', required=True, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--serial_batches', type=int, help='if true, takes images in order to make batches, otherwise takes them randomly')
